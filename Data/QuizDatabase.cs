    ...
    try
    {
        if (!File.Exists(FileName))
        {
            ...
            tableCmd.CommandText =
                ...
                ('Ile kontynentów jest na Ziemi?', '5', '6', '7', '8', 2, 'Geografia'),
                ('Największa planeta Układu Słonecznego to?', 'Mars', 'Jowisz', 'Ziemia', 'Wenus', 1, 'Astronomia'),
                ('Które państwo ma największą powierzchnię?', 'USA', 'Chiny', 'Rosja', 'Brazylia', 2, 'Geografia'),
                ...
                ('Który pierwiastek ma symbol Fe?', 'Fosfor', 'Fluor', 'Żelazo', 'Franc', 2, 'Chemia'),
                ('Stolica Niemiec to?', 'Berlin', 'Monachium', 'Hamburg', 'Frankfurt', 0, 'Geografia'),
                ('W którym państwie znajduje się Machu Picchu?', 'Meksyk', 'Peru', 'Chile', 'Boliwia', 1, 'Geografia'),
                ('Kto wynalazł żarówkę?', 'Edison', 'Tesla', 'Newton', 'Einstein', 0, 'Historia'),
                ('W jakim kraju znajduje się Wielki Mur?', 'Indie', 'Chiny', 'Japonia', 'Rosja', 1, 'Geografia'),
                ('Stolicą Hiszpanii jest?', 'Barcelona', 'Madryt', 'Walencja', 'Sewilla', 1, 'Geografia'),
                ...
                ('Który kontynent ma najwięcej państw?', 'Azja', 'Afryka', 'Europa', 'Ameryka', 1, 'Geografia'),
                ('Najdłuższa rzeka świata to?', 'Nil', 'Amazonka', 'Jangcy', 'Missisipi', 1, 'Geografia'),
                ...
                ('Jaki gaz dominuje w atmosferze?', 'Tlen', 'Azot', 'Dwutlenek węgla', 'Wodór', 1, 'Chemia'),
                ('Który kraj jest największy w Europie?', 'Niemcy', 'Francja', 'Ukraina', 'Hiszpania', 2, 'Geografia'),
                ...
                ('Największe miasto w Polsce to?', 'Kraków', 'Warszawa', 'Wrocław', 'Gdańsk', 1, 'Geografia'),
                ...
                ('Jaka jest największa pustynia świata?', 'Sahara', 'Gobi', 'Atakama', 'Kalahari', 0, 'Geografia'),
                ('Który ocean jest najgłębszy?', 'Atlantycki', 'Spokojny', 'Arktyczny', 'Indyjski', 1, 'Geografia'),
                ...
                ('Które miasto jest stolicą Australii?', 'Sydney', 'Melbourne', 'Canberra', 'Perth', 2, 'Geografia'),
                ('Który metal jest najlżejszy?', 'Żelazo', 'Miedź', 'Aluminium', 'Węgiel', 2, 'Chemia'),
                ('Jakiego koloru jest szmaragd?', 'Zielony', 'Czerwony', 'Biały', 'Niebieski', 0, 'Geografia'),
                ('Najwyższy wodospad na świecie to?', 'Niagara', 'Angel', 'Iguazu', 'Victoria', 1, 'Geografia'),
                ('Które państwo graniczy z największą liczbą krajów?', 'Rosja', 'Chiny', 'USA', 'Brazylia', 1, 'Geografia'),
                ('Kto napisał „Hamleta”?', 'Dickens', 'Szekspir', 'Hemingway', 'Tolkien', 1, 'Literatura'),
                ('Co oznacza skrót WWW?', 'Wide World Web', 'World Wide Web', 'Web Wide World', 'World Wide Website', 1, 'Informatyka'),
                ('Największy kontynent na świecie to?', 'Afryka', 'Ameryka Północna', 'Azja', 'Europa', 2, 'Geografia'),
                ('Jak nazywa się najwyższa góra w Polsce?', 'Babia Góra', 'Giewont', 'Śnieżka', 'Rysy', 3, 'Geografia'),
                ('Co to jest H2O?', 'Tlen', 'Woda', 'Wodór', 'Azot', 1, 'Chemia'),
                ('Które zwierzę jest ssakiem?', 'Żaba', 'Rekin', 'Nietoperz', 'Kura', 2, 'Biologia'),
                ('Które państwo nie graniczy z Polską?', 'Niemcy', 'Litwa', 'Słowacja', 'Rumunia', 3, 'Geografia'),
                ('Który pierwiastek ma symbol Na?', 'Sód', 'Wapń', 'Azot', 'Cynk', 0, 'Chemia'),
                ('W jakim kraju leży wieża Eiffla?', 'Niemcy', 'Włochy', 'Francja', 'Hiszpania', 2, 'Geografia'),
                ...
                ('W jakim roku człowiek pierwszy raz poleciał w kosmos?', '1961', '1957', '1969', '1972', 0, 'Historia'),
                ('Jaką jednostką mierzymy energię?', 'Wolt', 'Amper', 'Joule', 'Kelwin', 2, 'Fizyka'),
                ('Stolicą Norwegii jest?', 'Oslo', 'Sztokholm', 'Kopenhaga', 'Helsinki', 0, 'Geografia'),
                ('Ile lat ma jedna dekada?', '5', '10', '15', '20', 1, 'Ogólna wiedza'),
                ...
                ('Jakiego koloru jest flaga Niemiec?', 'Czarna, czerwona, złota', 'Biała, czerwona, niebieska', 'Czerwona, żółta, zielona', 'Czarna, zielona, czerwona', 0, 'Geografia'),
                ...
                ('Jakiego koloru są liście jesienią?', 'Czerwone', 'Żółte', 'Pomarańczowe', 'Wszystkie powyższe', 3, 'Biologia'),
                ('Które państwo nie ma dostępu do morza?', 'Austria', 'Włochy', 'Portugalia', 'Turcja', 0, 'Geografia'),
                ...
                ('Jakie jest największe państwo Afryki?', 'Nigeria', 'Egipt', 'Algieria', 'RPA', 2, 'Geografia'),
                ...
                ('Który wynalazca stworzył telefon?', 'Edison', 'Tesla', 'Bell', 'Newton', 2, 'Historia'),
                ('Które morze jest najcieplejsze?', 'Bałtyckie', 'Czarne', 'Czerwone', 'Śródziemne', 2, 'Geografia'),
                ...
                ('Z ilu kontynentów składa się świat?', '5', '6', '7', '8', 2, 'Geografia'),
                ...
                ('Jakiego koloru jest flaga Włoch?', 'Zielony, biały, czerwony', 'Czerwony, biały, niebieski', 'Żółty, niebieski, czerwony', 'Biały, czerwony, zielony', 0, 'Geografia'),
                ...
                ('Jakie jest najpopularniejsze hobby na świecie?', 'Wędkarstwo', 'Czytanie', 'Podróżowanie', 'Gotowanie', 0, 'Ogólna wiedza'),
                ('Co to jest haiku?', 'Rodzaj sushi', 'Rodzaj wiersza', 'Styl malarski', 'Taniec', 1, 'Kultura'),
                ('Które miasto leży jednocześnie w Europie i Azji?', 'Stambuł', 'Teheran', 'Moskwa', 'Jerozolima', 0, 'Geografia')
                ;
                ";
